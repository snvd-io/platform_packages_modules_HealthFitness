...
object Constants {
    ...
    const val READ_IMMUNIZATION = "android.permission.health.READ_MEDICAL_RESOURCES_IMMUNIZATION"
    const val WRITE_ALL_MEDICAL_DATA = "android.permission.health.WRITE_MEDICAL_RESOURCES"
